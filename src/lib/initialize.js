// This page is hidden, providing multi-window ESB support.
// Provides a "fenix" global variable containing everything
var gui = require('nw.gui');

// Initialize the Fenix JavaScript API
global.fenix = fenix = new require('./lib/fenix')(gui,{
  controller: gui.Window.get(this)
});

// If the app is in development mode, automatically show the dev tools
fenix.config.dev && fenix.controller.showDevTools();
...
fenix.showSplashScreen();


fenix.controller.on('close',function(){
...
//    win = {
//      splash: path.join('.','view','splash.html'),
//      main: path.join('.','view','main.html')
//    },
